          ...
          <div className="card p-6">
            ...
            <div className="space-y-3">
              {(weakTopics?.topics || []).slice(0, 8).map((t) => (
                <div key={t.topic}>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span className="text-dark-500">{t.problemCount} problems ({t.strengthScore}%)</span>
                  </div>
              ...
              {(!weakTopics?.topics || weakTopics.topics.length === 0) && (
                <p className="text-dark-500 text-sm">Connect your LeetCode account to see topic strengths.</p>
              )}
            </div>
          </div>
        </motion.div>
